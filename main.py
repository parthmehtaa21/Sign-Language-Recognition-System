...
def HomePage():
	...
	window.title("HOME - Sign Language Recognition")
	...
	def contactus():
		...
		cntct.title("About Team - Sign Language Recognition")
	...
	def aboutus():
		...
		about.title("About Project - Sign Language Recognition")
	...
	def exit():
		...
		result = tkMessageBox.askquestion("Sign Language Recognition", "Are you sure you want to exit?", icon= "warning")
		if result == 'yes':
			sys.exit()
...
def LoadingScreen():
	...
	root.title("Loading - Sign Language Recognition")
